...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_name",
        choices=["gpt2-xl", "EleutherAI/gpt-j-6B", "meta-llama/Llama-2-7b-hf", "meta-llama/Meta-Llama-3-8B"],
        help="Model to edit.",
        required=True,
    )
    parser.add_argument(
        "--hparams_fname",
        type=str,
        choices=["gpt2-xl.json", "EleutherAI_gpt-j-6B.json", "llama2-7b.json", "llama3-8b.json"],
        help="Name of hyperparameters file, located in the hparams/<alg_name> folder.",
        required=True,
    )
    parser.add_argument(
